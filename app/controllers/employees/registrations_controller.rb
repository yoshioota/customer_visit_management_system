...
class Employees::RegistrationsController < Devise::RegistrationsController
  ...
  before_action({only: [:new, :create]}) do
    raise if ENV['ADMIN_REGISTRATION'].to_i != 1
  end
  ...
  def account_update_params
    ...
    params.require(:employee).permit(:name, :email, :email, :password, :password_confirmation, :current_password)
  end
end
